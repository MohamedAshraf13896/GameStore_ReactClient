...
export function Register(props) {
  ...
  const url = "http://localhost:4151/api/Account/register";
  ...
  function submit(e) {
    ...
    axios
      ...
      .then((res) => {
        ...
        swal({
          title: "Success!",
          text: `${data.userName} Registered Successfuly`,
          icon: "success",
          buttons: "Ok!",
        });
        navigate("/Login");
    ...
    <>
      <div className="parent d-flex">
        <div className="imgdiv col-8 margins">
          <img className="imagee" alt="" src={register} />
        </div>
                ...
                <div className="row">
                  <div className="col-sm-12 mb-5">
                    <div className="form-group">
                      ...
                      >
                        <h2 className="errors">Create your account</h2>
                        <input
